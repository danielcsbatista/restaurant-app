  ...
  await prismaClient.$transaction(async (tx: any) => {
    ...
    const combosCategory = await tx.menuCategory.create({
      data: {
        ...
        slug: "combos",
        description: "Nossos melhores combos com preços imbatíveis!",
      },
    });
      ...
      data: [
        {
          ...
          slug: "mcoferta-media-big-mac-duplo",
          description:
    ...
    const hamburguersCategory = await tx.menuCategory.create({
      data: {
        ...
        restaurantId: restaurant.id,
        slug: "lanches",
        description: "Nossos melhores lanches para você saborear!",
      },
    });
    await tx.product.createMany({
      data: [
    ...
    const frenchFriesCategory = await tx.menuCategory.create({
      data: {
        ...
        restaurantId: restaurant.id,
        slug: "fritas",
        description: "As melhores fritas da cidade!",
      },
    });
    await tx.product.createMany({
      data: [
    ...
    const drinksCategory = await tx.menuCategory.create({
      data: {
        ...
        restaurantId: restaurant.id,
        slug: "bebidas",
        description: "As melhores bebidas para acompanhar seu lanche!",
      },
    });
    await tx.product.createMany({
      data: [
    ...
    const desertsCategory = await tx.menuCategory.create({
      data: {
        ...
        restaurantId: restaurant.id,
        slug: "sobremesas",
        description: "As melhores sobremesas para finalizar sua refeição!",
      },
    });
    await tx.product.createMany({
      data: [
